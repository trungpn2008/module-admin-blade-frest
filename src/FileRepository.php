...
use Trungpn\Modules\Exceptions\InvalidAssetPath;
use Trungpn\Modules\Exceptions\ModuleNotFoundException;
use Trungpn\Modules\Process\Installer;
use Trungpn\Modules\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
     ...
     * @return string
     * @throws \Trungpn\Modules\Exceptions\ModuleNotFoundException
     */
